...
public class Vulkan {
    ...
    private void transitionImageLayout(VkCommandBuffer cmdBuffer, long image, long srcAccessMask, long dstAccessMask, int oldLayout, int newLayout, long srcStageMask, long dstStageMask) {
        try(MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VK13.vkCmdPipelineBarrier2(cmdBuffer, dependencyInfo);
        }
    }
    ...
    private void endSingleTimeCommands(VkCommandBuffer commandBuffer) {
        try(MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VkSubmitInfo2.Buffer submitInfo2 = VkSubmitInfo2.calloc(1, stack)
                .sType$Default()
    ...
    private void createGraphicsPipeline() {
        try(MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VkVertexInputAttributeDescription.Buffer attributeBuffer = Vertex.getAttributeDescriptions(stack);
    ...
    private void createLogicalDevice() {
        ...
        try(MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VkPhysicalDeviceFeatures2 deviceFeatures2 = VkPhysicalDeviceFeatures2.calloc(stack)
                ...
                .pNext(VkPhysicalDeviceVulkan12Features.calloc(stack)
                    .sType$Default()
            ...
            VkDeviceQueueCreateInfo.Buffer queueCreateInfoBuffer = VkDeviceQueueCreateInfo.calloc(uniqueFamilies.length, stack);
            ...
            VkDeviceCreateInfo deviceCreateInfo = VkDeviceCreateInfo.calloc(stack)
                ...
                // Overwrite pNext instead of prepending
    ...
    public static class Vertex {
        ...
        private static VkVertexInputBindingDescription.Buffer getBindingDescription(MemoryStack stack) {
            ...
            return VkVertexInputBindingDescription.malloc(1, stack)
                .binding(0)
        ...
        private static VkVertexInputAttributeDescription.Buffer getAttributeDescriptions(MemoryStack stack) {
            VkVertexInputAttributeDescription.Buffer attributeDescriptions = VkVertexInputAttributeDescription.malloc(3, stack);
    ...
    private void drawFrame() {
        ...
        try(MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if(VK13.vkQueueSubmit2(graphicsQueue, submitInfo, inFlightFences[currentFrame]) != VK10.VK_SUCCESS) {
